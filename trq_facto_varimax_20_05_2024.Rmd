...
library(haven)
library(readr)
authors <- read_delim("~/OneDrive/TRQ_article/authors.csv", delim = ";", escape_double = FALSE, na = "empty", trim_ws = TRUE)
items <- read_sav("~/OneDrive/TRQ_article/ct_14_12_2022.sav")
...
facto1varimaxRMSEA <- round(facto1varimax$RMSEA[["RMSEA"]],3) 
facto1varimaxrmsr <- round(facto1varimax$rms,3)
facto1varimaxTLI <- round(facto1varimax$TLI,3)
...
facto2varimaxRMSEA <- round(facto2varimax$RMSEA[["RMSEA"]],3) 
facto2varimaxrmsr <- round(facto2varimax$rms,3)
facto2varimaxTLI <- round(facto2varimax$TLI,3)
...
facto3varimaxRMSEA <- round(facto3varimax$RMSEA[["RMSEA"]],3) 
facto3varimaxrmsr <- round(facto3varimax$rms,3)
facto3varimaxTLI <- round(facto3varimax$TLI,3)
...
facto4varimaxRMSEA <- round(facto4varimax$RMSEA[["RMSEA"]],3) 
facto4varimaxrmsr <- round(facto4varimax$rms,3)
facto4varimaxTLI <- round(facto4varimax$TLI,3)
...
facto5varimaxRMSEA <- round(facto5varimax$RMSEA[["RMSEA"]],3) 
facto5varimaxrmsr <- round(facto5varimax$rms,3)
facto5varimaxTLI <- round(facto5varimax$TLI,3)
...
facto6varimaxRMSEA <- round(facto6varimax$RMSEA[["RMSEA"]],3) 
facto6varimaxrmsr <- round(facto6varimax$rms,3)
facto6varimaxTLI <- round(facto6varimax$TLI,3)
...
facto7varimaxRMSEA <- round(facto7varimax$RMSEA[["RMSEA"]],3) 
facto7varimaxrmsr <- round(facto7varimax$rms,3)
facto7varimaxTLI <- round(facto7varimax$TLI,3)
...
facto8varimaxRMSEA <- round(facto8varimax$RMSEA[["RMSEA"]],3) 
facto8varimaxrmsr <- round(facto8varimax$rms,3)
facto8varimaxTLI <- round(facto8varimax$TLI,3)
...
facto9varimaxRMSEA <- round(facto9varimax$RMSEA[["RMSEA"]],3) 
facto9varimaxrmsr <- round(facto9varimax$rms,3)
facto9varimaxTLI <- round(facto9varimax$TLI,3)
...
facto10varimaxRMSEA <- round(facto10varimax$RMSEA[["RMSEA"]],3) 
facto10varimaxrmsr <- round(facto10varimax$rms,3)
facto10varimaxTLI <- round(facto10varimax$TLI,3)
...
Le premier facteur compte `r n10_varimax_1` items, le deuxième `r n10_varimax_2` items le troisième `r n10_varimax_3` items, le quatrième `r n10_varimax_4` items, le cinquième `r n10_varimax_5` items, le sixième `r n10_varimax_6` items, le septième `r n10_varimax_7` items, le huitième `r n10_varimax_8` items, le neuvième `r n10_varimax_9` items, le dixième `r n10_varimax_10` items, pour un total de `r n10_varimax` items.
...
comparaisonvarimax.df <- data.frame(
  ...
  RMSEAlow= c(round(facto1varimax$RMSEA[["lower"]],3), round(facto2varimax$RMSEA[["lower"]],3), round(facto3varimax$RMSEA[["lower"]],3), round(facto4varimax$RMSEA[["lower"]],3), round(facto5varimax$RMSEA[["lower"]],3), round(facto6varimax$RMSEA[["lower"]],3), round(facto7varimax$RMSEA[["lower"]],3), round(facto8varimax$RMSEA[["lower"]],3), round(facto9varimax$RMSEA[["lower"]],3), round(facto10varimax$RMSEA[["lower"]],3)),
  RMSEAup= c(round(facto1varimax$RMSEA[["upper"]],3), round(facto2varimax$RMSEA[["upper"]],3), round(facto3varimax$RMSEA[["upper"]],3), round(facto4varimax$RMSEA[["upper"]],3), round(facto5varimax$RMSEA[["upper"]],3), round(facto6varimax$RMSEA[["upper"]],3), round(facto7varimax$RMSEA[["upper"]],3), round(facto8varimax$RMSEA[["upper"]],3), round(facto9varimax$RMSEA[["upper"]],3), round(facto10varimax$RMSEA[["upper"]],3)),

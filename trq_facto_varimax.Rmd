...
# alpha de Cronbach
# créer une data-frame avec les items retenus
rownamesfacto11_varimax_1 <- rownames(facto11varimax_1.df) #récupérer le nom des variables retenues
items_facto11_varimax_1 <- subset(items.df, select = rownamesfacto11_varimax_1) # ne retenir que les items dont le nom à été récupéré

items_facto11_varimax_1_alpharesults <- psych::alpha(items_facto11_varimax_1, check.keys=TRUE)
items_facto11_varimax_1_alpha <- round(items_facto11_varimax_1_alpharesults$total$std.alpha, 2)
items_facto11_varimax_1_alpha
```

**Alpha (standard) de Cronbach = `r items_facto11_varimax_1_alpha`**

```{r}
kbl(facto11varimax_1table_ord, booktabs = T) %>%
kable_styling(full_width = T) %>%
column_spec(3, width = "12cm")
```
...
# alpha de Cronbach
# créer une data-frame avec les items retenus
rownamesfacto11_varimax_2 <- rownames(facto11varimax_2.df) #récupérer le nom des variables retenues
items_facto11_varimax_2 <- subset(items.df, select = rownamesfacto11_varimax_2) # ne retenir que les items dont le nom à été récupéré

items_facto11_varimax_2_alpharesults <- psych::alpha(items_facto11_varimax_2, check.keys=TRUE)
items_facto11_varimax_2_alpha <- round(items_facto11_varimax_2_alpharesults$total$std.alpha, 2)
items_facto11_varimax_2_alpha
```

**Alpha (standard) de Cronbach = `r items_facto11_varimax_2_alpha`**

```{r}
kbl(facto11varimax_2table_ord, booktabs = T) %>%
kable_styling(full_width = T) %>%
column_spec(3, width = "12cm")
```
...
# alpha de Cronbach
# créer une data-frame avec les items retenus
rownamesfacto11_varimax_3 <- rownames(facto11varimax_3.df) #récupérer le nom des variables retenues
items_facto11_varimax_3 <- subset(items.df, select = rownamesfacto11_varimax_3) # ne retenir que les items dont le nom à été récupéré

items_facto11_varimax_3_alpharesults <- psych::alpha(items_facto11_varimax_3, check.keys=TRUE)
items_facto11_varimax_3_alpha <- round(items_facto11_varimax_3_alpharesults$total$std.alpha, 2)
items_facto11_varimax_3_alpha
```

**Alpha (standard) de Cronbach = `r items_facto11_varimax_3_alpha`**

```{r}
kbl(facto11varimax_3table_ord, booktabs = T) %>%
kable_styling(full_width = T) %>%
column_spec(3, width = "12cm")
```
...
# alpha de Cronbach
# créer une data-frame avec les items retenus
rownamesfacto11_varimax_4 <- rownames(facto11varimax_4.df) #récupérer le nom des variables retenues
items_facto11_varimax_4 <- subset(items.df, select = rownamesfacto11_varimax_4) # ne retenir que les items dont le nom à été récupéré

items_facto11_varimax_4_alpharesults <- psych::alpha(items_facto11_varimax_4, check.keys=TRUE)
items_facto11_varimax_4_alpha <- round(items_facto11_varimax_4_alpharesults$total$std.alpha, 2)
items_facto11_varimax_4_alpha
```

**Alpha (standard) de Cronbach = `r items_facto11_varimax_4_alpha`**

```{r}
kbl(facto11varimax_4table_ord, booktabs = T) %>%
kable_styling(full_width = T) %>%
column_spec(3, width = "12cm")
```
...
# alpha de Cronbach
# créer une data-frame avec les items retenus
rownamesfacto11_varimax_5 <- rownames(facto11varimax_5.df) #récupérer le nom des variables retenues
items_facto11_varimax_5 <- subset(items.df, select = rownamesfacto11_varimax_5) # ne retenir que les items dont le nom à été récupéré

items_facto11_varimax_5_alpharesults <- psych::alpha(items_facto11_varimax_5, check.keys=TRUE)
items_facto11_varimax_5_alpha <- round(items_facto11_varimax_5_alpharesults$total$std.alpha, 2)
items_facto11_varimax_5_alpha
```

**Alpha (standard) de Cronbach = `r items_facto11_varimax_5_alpha`**

```{r}
kbl(facto11varimax_5table_ord, booktabs = T) %>%
kable_styling(full_width = T) %>%
column_spec(3, width = "12cm")
```
...
# alpha de Cronbach
# créer une data-frame avec les items retenus
rownamesfacto11_varimax_6 <- rownames(facto11varimax_6.df) #récupérer le nom des variables retenues
items_facto11_varimax_6 <- subset(items.df, select = rownamesfacto11_varimax_6) # ne retenir que les items dont le nom à été récupéré

items_facto11_varimax_6_alpharesults <- psych::alpha(items_facto11_varimax_6, check.keys=TRUE)
items_facto11_varimax_6_alpha <- round(items_facto11_varimax_6_alpharesults$total$std.alpha, 2)
items_facto11_varimax_6_alpha
```

**Alpha (standard) de Cronbach = `r items_facto11_varimax_6_alpha`**

```{r}
kbl(facto11varimax_6table_ord, booktabs = T) %>%
kable_styling(full_width = T) %>%
column_spec(3, width = "12cm")
```
...
# alpha de Cronbach
# créer une data-frame avec les items retenus
rownamesfacto11_varimax_7 <- rownames(facto11varimax_7.df) #récupérer le nom des variables retenues
items_facto11_varimax_7 <- subset(items.df, select = rownamesfacto11_varimax_7) # ne retenir que les items dont le nom à été récupéré

items_facto11_varimax_7_alpharesults <- psych::alpha(items_facto11_varimax_7, check.keys=TRUE)
items_facto11_varimax_7_alpha <- round(items_facto11_varimax_7_alpharesults$total$std.alpha, 2)
items_facto11_varimax_7_alpha
```

**Alpha (standard) de Cronbach = `r items_facto11_varimax_7_alpha`**

```{r}
kbl(facto11varimax_7table_ord, booktabs = T) %>%
kable_styling(full_width = T) %>%
column_spec(3, width = "12cm")
```
...
# alpha de Cronbach
# créer une data-frame avec les items retenus
rownamesfacto11_varimax_8 <- rownames(facto11varimax_8.df) #récupérer le nom des variables retenues
items_facto11_varimax_8 <- subset(items.df, select = rownamesfacto11_varimax_8) # ne retenir que les items dont le nom à été récupéré

items_facto11_varimax_8_alpharesults <- psych::alpha(items_facto11_varimax_8, check.keys=TRUE)
items_facto11_varimax_8_alpha <- round(items_facto11_varimax_8_alpharesults$total$std.alpha, 2)
items_facto11_varimax_8_alpha
```

**Alpha (standard) de Cronbach = `r items_facto11_varimax_8_alpha`**

```{r}
kbl(facto11varimax_8table_ord, booktabs = T) %>%
kable_styling(full_width = T) %>%
column_spec(3, width = "12cm")
```
...
# alpha de Cronbach
# créer une data-frame avec les items retenus
rownamesfacto11_varimax_9 <- rownames(facto11varimax_9.df) #récupérer le nom des variables retenues
items_facto11_varimax_9 <- subset(items.df, select = rownamesfacto11_varimax_9) # ne retenir que les items dont le nom à été récupéré

items_facto11_varimax_9_alpharesults <- psych::alpha(items_facto11_varimax_9, check.keys=TRUE)
items_facto11_varimax_9_alpha <- round(items_facto11_varimax_9_alpharesults$total$std.alpha, 2)
items_facto11_varimax_9_alpha
```

**Alpha (standard) de Cronbach = `r items_facto11_varimax_9_alpha`**

```{r}
kbl(facto11varimax_9table_ord, booktabs = T) %>%
kable_styling(full_width = T) %>%
column_spec(3, width = "12cm")
```
...
```{r}
kbl(facto11varimax_10table_ord, booktabs = T) %>%
kable_styling(full_width = T) %>%
column_spec(3, width = "12cm")
```
...
```{r}
kbl(facto11varimax_11table_ord, booktabs = T) %>%
kable_styling(full_width = T) %>%
column_spec(3, width = "12cm")
```

...
comparaisonvarimax.df <- data.frame(
  ...
  RMSEAlow= c(round(facto1varimax$RMSEA[["lower"]],2), round(facto2varimax$RMSEA[["lower"]],2), round(facto3varimax$RMSEA[["lower"]],2), round(facto4varimax$RMSEA[["lower"]],2), round(facto5varimax$RMSEA[["lower"]],2), round(facto6varimax$RMSEA[["lower"]],2), round(facto7varimax$RMSEA[["lower"]],2), round(facto8varimax$RMSEA[["lower"]],2), round(facto9varimax$RMSEA[["lower"]],2), round(facto10varimax$RMSEA[["lower"]],2)),
  RMSEAup= c(round(facto1varimax$RMSEA[["upper"]],2), round(facto2varimax$RMSEA[["upper"]],2), round(facto3varimax$RMSEA[["upper"]],2), round(facto4varimax$RMSEA[["upper"]],2), round(facto5varimax$RMSEA[["upper"]],2), round(facto6varimax$RMSEA[["upper"]],2), round(facto7varimax$RMSEA[["upper"]],2), round(facto8varimax$RMSEA[["upper"]],2), round(facto9varimax$RMSEA[["upper"]],2), round(facto10varimax$RMSEA[["upper"]],2)),
